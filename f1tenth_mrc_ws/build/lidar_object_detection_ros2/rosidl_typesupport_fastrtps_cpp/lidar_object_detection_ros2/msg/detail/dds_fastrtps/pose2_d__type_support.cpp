...
#include "lidar_object_detection_ros2/msg/detail/pose2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const lidar_object_detection_ros2::msg::Pose2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lidar_object_detection_ros2::msg::Pose2D *>(
    untyped_ros_message);
...
{
  return &lidar_object_detection_ros2::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}
