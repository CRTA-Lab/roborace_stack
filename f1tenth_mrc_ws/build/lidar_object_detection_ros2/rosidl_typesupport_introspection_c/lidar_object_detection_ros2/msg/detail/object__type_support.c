...
// Member `l_shape`
#include "lidar_object_detection_ros2/msg/l_shape.h"
// Member `l_shape`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  lidar_object_detection_ros2__msg__Object__init(message_memory);
}

void Object__rosidl_typesupport_introspection_c__Object_fini_function(void * message_memory)
{
  lidar_object_detection_ros2__msg__Object__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Object__rosidl_typesupport_introspection_c__Object_message_member_array[3] = {
  {
    ...
    offsetof(lidar_object_detection_ros2__msg__Object, id),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lidar_object_detection_ros2__msg__Object, l_shape),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lidar_object_detection_ros2__msg__Object, pose),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Object__rosidl_typesupport_introspection_c__Object_message_members = {
  ...
  "Object",  // message name
  3,  // number of fields
  sizeof(lidar_object_detection_ros2__msg__Object),
