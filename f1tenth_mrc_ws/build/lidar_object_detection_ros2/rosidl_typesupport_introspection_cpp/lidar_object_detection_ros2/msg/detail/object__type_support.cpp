...
{
  new (message_memory) lidar_object_detection_ros2::msg::Object(_init);
}

void Object_fini_function(void * message_memory)
{
  auto typed_message = static_cast<lidar_object_detection_ros2::msg::Object *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Object_message_member_array[3] = {
  {
    ...
    offsetof(lidar_object_detection_ros2::msg::Object, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<lidar_object_detection_ros2::msg::LShape>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(lidar_object_detection_ros2::msg::Object, l_shape),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lidar_object_detection_ros2::msg::Object, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Object_message_members = {
  ...
  "Object",  // message name
  3,  // number of fields
  sizeof(lidar_object_detection_ros2::msg::Object),
...
{
  return &::lidar_object_detection_ros2::msg::rosidl_typesupport_introspection_cpp::Object_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lidar_object_detection_ros2, msg, Object)() {
  return &::lidar_object_detection_ros2::msg::rosidl_typesupport_introspection_cpp::Object_message_type_support_handle;
}
