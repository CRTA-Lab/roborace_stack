...
static size_t _CalibConfigRead_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_realsense2_camera_msgs__srv__CalibConfigRead_Request(
    full_bounded, 0);
}
...
static size_t _CalibConfigRead_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_realsense2_camera_msgs__srv__CalibConfigRead_Response(
    full_bounded, 0);
}
