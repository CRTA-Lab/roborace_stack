...
void CalibConfigWrite_Request__rosidl_typesupport_introspection_c__CalibConfigWrite_Request_init_function(
...
void CalibConfigWrite_Request__rosidl_typesupport_introspection_c__CalibConfigWrite_Request_fini_function(void * message_memory)
{
  realsense2_camera_msgs__srv__CalibConfigWrite_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember CalibConfigWrite_Request__rosidl_typesupport_introspection_c__CalibConfigWrite_Request_message_member_array[1] = {
  {
    "calib_config",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers CalibConfigWrite_Request__rosidl_typesupport_introspection_c__CalibConfigWrite_Request_message_members = {
  ...
  CalibConfigWrite_Request__rosidl_typesupport_introspection_c__CalibConfigWrite_Request_message_member_array,  // message members
  CalibConfigWrite_Request__rosidl_typesupport_introspection_c__CalibConfigWrite_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  CalibConfigWrite_Request__rosidl_typesupport_introspection_c__CalibConfigWrite_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t CalibConfigWrite_Request__rosidl_typesupport_introspection_c__CalibConfigWrite_Request_message_type_support_handle = {
  0,
  &CalibConfigWrite_Request__rosidl_typesupport_introspection_c__CalibConfigWrite_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense2_camera_msgs, srv, CalibConfigWrite_Request)() {
  if (!CalibConfigWrite_Request__rosidl_typesupport_introspection_c__CalibConfigWrite_Request_message_type_support_handle.typesupport_identifier) {
    CalibConfigWrite_Request__rosidl_typesupport_introspection_c__CalibConfigWrite_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &CalibConfigWrite_Request__rosidl_typesupport_introspection_c__CalibConfigWrite_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void CalibConfigWrite_Response__rosidl_typesupport_introspection_c__CalibConfigWrite_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void CalibConfigWrite_Response__rosidl_typesupport_introspection_c__CalibConfigWrite_Response_fini_function(void * message_memory)
{
  realsense2_camera_msgs__srv__CalibConfigWrite_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember CalibConfigWrite_Response__rosidl_typesupport_introspection_c__CalibConfigWrite_Response_message_member_array[2] = {
  {
    "success",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers CalibConfigWrite_Response__rosidl_typesupport_introspection_c__CalibConfigWrite_Response_message_members = {
  "realsense2_camera_msgs__srv",  // message namespace
  "CalibConfigWrite_Response",  // message name
  2,  // number of fields
  sizeof(realsense2_camera_msgs__srv__CalibConfigWrite_Response),
  CalibConfigWrite_Response__rosidl_typesupport_introspection_c__CalibConfigWrite_Response_message_member_array,  // message members
  CalibConfigWrite_Response__rosidl_typesupport_introspection_c__CalibConfigWrite_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  CalibConfigWrite_Response__rosidl_typesupport_introspection_c__CalibConfigWrite_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t CalibConfigWrite_Response__rosidl_typesupport_introspection_c__CalibConfigWrite_Response_message_type_support_handle = {
  0,
  &CalibConfigWrite_Response__rosidl_typesupport_introspection_c__CalibConfigWrite_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense2_camera_msgs, srv, CalibConfigWrite_Response)() {
  if (!CalibConfigWrite_Response__rosidl_typesupport_introspection_c__CalibConfigWrite_Response_message_type_support_handle.typesupport_identifier) {
    CalibConfigWrite_Response__rosidl_typesupport_introspection_c__CalibConfigWrite_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &CalibConfigWrite_Response__rosidl_typesupport_introspection_c__CalibConfigWrite_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
