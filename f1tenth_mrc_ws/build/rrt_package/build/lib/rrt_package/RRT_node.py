...
class RRT(Node):
    ...
    def __init__(self):
        ...
        # Load map yaml file
        map_yaml_path = '/home/f1tenth/f1tenth_mrc_ws/src/rrt_package/maps/blank_map.yaml'
        ...
        self.inflation_radius = int(0.05/self.resolution)
    ...
    def random_free(self, goal, bias_prob = 0.15):
    ...
    def pose_callback(self, pose_msg):
        ...
        while k < 200 and not found_goal:
            ...
            #print(x_nearest, x_rand)
            #self.get_logger().info(f"random_point, nearest: {x_rand, x_nearest}")
