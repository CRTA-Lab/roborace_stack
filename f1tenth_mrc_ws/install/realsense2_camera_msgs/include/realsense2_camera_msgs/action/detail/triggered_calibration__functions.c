  ...
  realsense2_camera_msgs__action__TriggeredCalibration_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    realsense2_camera_msgs__action__TriggeredCalibration_Goal * data =
      (realsense2_camera_msgs__action__TriggeredCalibration_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!realsense2_camera_msgs__action__TriggeredCalibration_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          realsense2_camera_msgs__action__TriggeredCalibration_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  realsense2_camera_msgs__action__TriggeredCalibration_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    realsense2_camera_msgs__action__TriggeredCalibration_Result * data =
      (realsense2_camera_msgs__action__TriggeredCalibration_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!realsense2_camera_msgs__action__TriggeredCalibration_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          realsense2_camera_msgs__action__TriggeredCalibration_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  realsense2_camera_msgs__action__TriggeredCalibration_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    realsense2_camera_msgs__action__TriggeredCalibration_Feedback * data =
      (realsense2_camera_msgs__action__TriggeredCalibration_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!realsense2_camera_msgs__action__TriggeredCalibration_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          realsense2_camera_msgs__action__TriggeredCalibration_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  realsense2_camera_msgs__action__TriggeredCalibration_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    realsense2_camera_msgs__action__TriggeredCalibration_SendGoal_Request * data =
      (realsense2_camera_msgs__action__TriggeredCalibration_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!realsense2_camera_msgs__action__TriggeredCalibration_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          realsense2_camera_msgs__action__TriggeredCalibration_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  realsense2_camera_msgs__action__TriggeredCalibration_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    realsense2_camera_msgs__action__TriggeredCalibration_SendGoal_Response * data =
      (realsense2_camera_msgs__action__TriggeredCalibration_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!realsense2_camera_msgs__action__TriggeredCalibration_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          realsense2_camera_msgs__action__TriggeredCalibration_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  realsense2_camera_msgs__action__TriggeredCalibration_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    realsense2_camera_msgs__action__TriggeredCalibration_GetResult_Request * data =
      (realsense2_camera_msgs__action__TriggeredCalibration_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!realsense2_camera_msgs__action__TriggeredCalibration_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          realsense2_camera_msgs__action__TriggeredCalibration_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  realsense2_camera_msgs__action__TriggeredCalibration_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    realsense2_camera_msgs__action__TriggeredCalibration_GetResult_Response * data =
      (realsense2_camera_msgs__action__TriggeredCalibration_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!realsense2_camera_msgs__action__TriggeredCalibration_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          realsense2_camera_msgs__action__TriggeredCalibration_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  realsense2_camera_msgs__action__TriggeredCalibration_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    realsense2_camera_msgs__action__TriggeredCalibration_FeedbackMessage * data =
      (realsense2_camera_msgs__action__TriggeredCalibration_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!realsense2_camera_msgs__action__TriggeredCalibration_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          realsense2_camera_msgs__action__TriggeredCalibration_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
