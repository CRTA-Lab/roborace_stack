  ...
  realsense2_camera_msgs__srv__CalibConfigRead_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    realsense2_camera_msgs__srv__CalibConfigRead_Request * data =
      (realsense2_camera_msgs__srv__CalibConfigRead_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!realsense2_camera_msgs__srv__CalibConfigRead_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          realsense2_camera_msgs__srv__CalibConfigRead_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  realsense2_camera_msgs__srv__CalibConfigRead_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    realsense2_camera_msgs__srv__CalibConfigRead_Response * data =
      (realsense2_camera_msgs__srv__CalibConfigRead_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!realsense2_camera_msgs__srv__CalibConfigRead_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          realsense2_camera_msgs__srv__CalibConfigRead_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
