...
class PolicyNode(Node):
    def __init__(self):
        ...
        self.actor = ActorNetwork(input_dims=183, n_actions=2, alpha=3e-4,
                                  chkpt_dir='/home/mrc/sim_ws/src/ppo_racing/ppo_racing/tmp/ppo9')
    ...
    def step_policy(self):
        if None in (self.ego_pose, self.opp_pose, self.ego_scan_short, self.opp_scan_short):
            return
